...
public class DESService implements SymmetricAlgorithm {

    private static final String ALGORITHM_MODE = "DES/ECB/PKCS5Padding";
    private static final int DEFAULT_KEY_BITS = 56; // DES usa 56 bits
    ...
    public String encryptMessage(String plainText, Integer keyBites) throws GeneralSecurityException {
        SecretKey key = SymmetricAlgorithm.generateKey(Algorithms.DES, keyBites);
    ...
    public String decryptMessage(String cipherTextBase64, String keyBase64) throws GeneralSecurityException {
        ...
        SecretKey key = SymmetricAlgorithm.base64KeyDecode(keyBase64, Algorithms.DES);
    ...
    public void encryptFile(File inputFile, File outputFile, int keyBits) throws GeneralSecurityException, IOException {
        SecretKey key = SymmetricAlgorithm.generateKey(Algorithms.DES, keyBits);
    ...
    public void decryptFile(String base64Key, File inputFile, File outputFile) throws GeneralSecurityException, IOException {
        SecretKey key = SymmetricAlgorithm.base64KeyDecode(base64Key, Algorithms.DES);
